...
const RecentProject = () => {
  return (
    <div className='py-20' id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-80">
        {projects.map(({id, title, des, img, iconLists, link})=>(
          <div key={id} className="sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] items-center justify-center sm:w-[570px] w-[80vh]">
            <PinContainer title="Visit" href={link}>
              ...
              <div className="flex items-center justify-between mt-7 mb-4">
                ...
                <p className="flex lg:text-cl md:text-xs text-sm text-purple">Check Live Site</p>
